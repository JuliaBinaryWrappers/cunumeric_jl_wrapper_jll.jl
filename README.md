# `cunumeric_jl_wrapper_jll.jl` (v25.10.2+1)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/702210a2ac3fda83d047030f504e8fa14f1f6085/C/cunumeric_jl_wrapper/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* `Platform("x86_64", "linux"; cuda = "13.0", julia_version = "1.12.0", libc = "glibc", cxxstring_abi = "cxx11")` (`x86_64-linux-gnu-cxx11-cuda+13.0-julia_version+1.12.0`)
